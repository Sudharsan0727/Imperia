        ...
        html: `
            ...
            <head>
                <style>
                    ...
                    .header { background-color: #1a1a1a; padding: 30px; text-align: center; border-bottom: 4px solid #82a330; }
                    .header h1 { color: #82a330; margin: 0; font-size: 24px; letter-spacing: 2px; text-transform: uppercase; }
                    ...
                    .lead-details { background-color: #fcfaf7; border-left: 4px solid #82a330; padding: 20px; margin: 20px 0; border-radius: 0 4px 4px 0; }
                    .detail-item { margin-bottom: 15px; display: flex; align-items: baseline; }
                    .label { font-weight: bold; color: #82a330; min-width: 100px; text-transform: uppercase; font-size: 12px; }
                    ...
                    .brand-name { color: #82a330; font-weight: bold; }
                </style>
            </head>
            <body>
