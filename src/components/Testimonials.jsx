...
const testimonials = [
    {
        ...
        name: "Prem Chandran",
        role: "Resident",
        quote: "For anyone looking at reviews before booking an apartment at Radiance Imperia in Thoraipakkam, honestly there’s no need to keep searching around for better options. We’re really happy that we decided to book our apartment here.\n\nCustomer service – 5/5\nLocation – 5/5",
        rating: 5,
    },
    {
        id: 2,
        name: "Aishwarya G",
        role: "Resident",
        quote: "Radiance Imperia Thoraipakkam has good specifications of flats and other amenities. Happy to become a part of Radiance family.",
        rating: 5,
    },
    {
        id: 3,
        name: "Karthikeyan T",
        role: "Resident",
        quote: "Recently bought an apartment at Radiance Imperia. The project is well planned with good layouts, decent amenities, and a convenient location. Sales team was responsive and the booking process was smooth. Looking forward to timely completion and handover.",
        rating: 5,
    }
];
                ...
                <div className="text-center mb-16 animate-fade-up">
                    ...
                    <div className="flex items-center justify-center gap-2 md:gap-3 w-max mx-auto mt-2">
                        ...
                        <div className="flex items-baseline gap-1.5 ml-1">
                            ...
                            <span className="text-2xl md:text-3xl font-normal text-black leading-none tracking-tight">4.8</span>
                        </div>
